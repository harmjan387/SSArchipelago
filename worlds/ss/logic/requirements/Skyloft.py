SKYLOFT_REQUIREMENTS = {
    "Upper Skyloft": {
        ...
        "exits": {
            "Knight Academy Lower Door": "Nothing",
            "Knight Academy Upper Door": "Nothing",
    ...
    "Central Skyloft": {
        ...
        "exits": {
            ...
            "Bazaar North Entrance": "Nothing",
            "Bazaar South Entrance": "Nothing",
            "Bazaar West Entrance": "Nothing",
            "Orielle and Parrow's House": "Nothing",
            "Kukiel's House": "Nothing",
            "Piper's House": "Nothing",
            "Peatrice's House": "Nothing",
            "Waterfall Cave": "Can Cut Trees",
    ...
    "Central Skyloft - Under Waterfall": {
        "hint_region": "Central Skyloft",
        "exits": {
            "Cave Entrance": "Nothing",
            "Loftwing Platforms": "Nothing",
        },
        "locations": {
            # Single crystals
            "Crystal after Waterfall Cave": "Nothing",
            "Crystal in Loftwing Prison": "Nothing",
        },
    },
    ...
    "Central Skyloft - Waterfall Cave": {
        "hint_region": "Central Skyloft",
        "exits": {
            "Upper Cave Exit": "Nothing",
            "Lower Cave Exit": "Nothing",
        },
        "locations": {
    ...
    "Beedle's Shop": {
        ...
        "exits": {
            "Shop Day Exit": "Nothing",
            "Shop Night Exit": "Nothing",
        },
        "locations": {
            "300 Rupee Item": (
